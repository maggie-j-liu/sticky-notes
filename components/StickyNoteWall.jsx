      ...
      {user ? (
        <div className={"flex justify-center items-center"}>
          <button
            onClick={openModal}
            className={
              "mt-10 mb-2 rounded-md px-6 py-4 bg-gradient-to-br from-indigo-600 via-purple-500 to-pink-400 text-primary-50 font-bold hover:scale-110 duration-200 hover:shadow-xl"
            }
          >
            Add sticky note
          </button>
